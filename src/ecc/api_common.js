...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // EVTkey...
})
    */
    ...
    */
    sign: async (data, privateKey, encoding = "utf8") => {
        if(encoding === true) {
        ...
        return (await Signature.sign(data, privateKey, encoding)).toString();
    },
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (EVTbase58sig.., Hex, Buffer)
