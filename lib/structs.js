...
module.exports = function () {
    ...
    var customTypes = (0, _assign2.default)({}, eosTypes, config.customTypes);
...
var Name128 = function Name128(validation) {
    return {
        ...
        appendByteBuffer: function appendByteBuffer(b, value) {
            ...
            //   console.error(`${value}`, (Name.appendByteBuffer))
            // }
            var bytes = encodeName128(value, false);
    ...
    return function (validation) {
        return {
            fromByteBuffer: function fromByteBuffer(b) {
                ...
                try {
                    for (var _iterator2 = (0, _getIterator3.default)(bin), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
