...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        value: function getDomainDetail(name) {
            var res;
            return regeneratorRuntime.async(function getDomainDetail$(_context11) {
                while (1) {
        ...
        value: function getFungibleBalance(address, symbol) {
            ...
            return regeneratorRuntime.async(function getFungibleBalance$(_context12) {
                while (1) {
        ...
        value: function getGroupDetail(name) {
            var res;
            return regeneratorRuntime.async(function getGroupDetail$(_context13) {
                while (1) {
        ...
        value: function getTransactionsDetailOfPublicKeys(publicKeys) {
            ...
            var body, res;
            return regeneratorRuntime.async(function getTransactionsDetailOfPublicKeys$(_context14) {
                while (1) {
        ...
        value: function getFungibleSymbolDetail(name) {
            var res;
            return regeneratorRuntime.async(function getFungibleSymbolDetail$(_context15) {
                while (1) {
        ...
        value: function __fixedSignatureCall(args) {
            ...
            return regeneratorRuntime.async(function __fixedSignatureCall$(_context16) {
                while (1) {
        ...
        value: function pushTransaction() {
            ...
            return regeneratorRuntime.async(function pushTransaction$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            ...
                            for (i = 0; i < _args17.length; ++i) {
                                actions.push(_args17[i]);
                            }
                        ...
                        case 11:
                            ...
                            _context17.t0 = originalAction.actionName;
                            _context17.next = 17;
                            return regeneratorRuntime.awrap(this.__chainAbiJsonToBin({ action: originalAction.actionName, args: originalAction.abi }));

                        case 17:
                            _context17.t1 = _context17.sent.binargs;
                            _context17.t2 = originalAction.domain;
                            _context17.t3 = originalAction.key;
                            binAction = {
                                name: _context17.t0,
                                data: _context17.t1,
                                domain: _context17.t2,
                                key: _context17.t3
                            };
                        ...
                        case 36:
                            digestRes = _context17.sent.digest;
                        ...
                        case 45:
                            ...
                            return _context17.abrupt("return", { transactionId: res.transaction_id });
        ...
        value: function __chainAbiJsonToBin(abi) {
            var ret;
            return regeneratorRuntime.async(function __chainAbiJsonToBin$(_context18) {
                while (1) {
        ...
        value: function __getDigestToSign(transaction) {
            var ret;
            return regeneratorRuntime.async(function __getDigestToSign$(_context19) {
                while (1) {
        ...
        return regeneratorRuntime.async(function _callee$(_context20) {
            while (1) {
                switch (_context20.prev = _context20.next) {
                    ...
                    case 55:
                        _context20.prev = 55;
                        _context20.t1 = _context20["catch"](51);
                    ...
                    case 76:
                        _context20.prev = 76;
                        _context20.t2 = _context20["catch"](72);
                    ...
                    case 88:
                        return _context20.abrupt("return", sigs);
