...
var APICaller = function () {
    ...
    (0, _createClass3.default)(APICaller, [{
        ...
        value: function () {
            var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(address, symbol) {
            ...
            function getFungibleBalance(_x14, _x15) {
        ...
        value: function () {
            var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(publicKeys) {
            ...
            function getTransactionsDetailOfPublicKeys(_x19) {
        ...
        value: function () {
            ...
            function getFungibleSymbolDetail(_x20) {
        ...
        value: function () {
            var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(keyProvider, trx) {
                ...
                }, _callee18, this, [[10, 21, 25, 33], [26,, 28, 32]]);
            }));

            function __calcKeyProvider(_x21, _x22) {
        ...
        value: function () {
            var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(keyProvider) {
            ...
            function __calcPublicKeyProvider(_x23) {
                    ...
                    while (1) {
                        switch (_context20.prev = _context20.next) {
                            case 0:
                                ...
                                if (_args20.length > 0 && !(_args20[0] instanceof EvtAction) && !_args20[0].action) {
                                    // config found
                                    (0, _assign2.default)(trxConf, _args20[0]);
                                    hasConfig = true;
                                }
                            ...
                            case 16:
                                ...
                                for (i = hasConfig ? 1 : 0; i < _args20.length; ++i) {
                                    actions.push(_args20[i]);
                                }
                            ...
                            case 33:
                                ...
                                _context20.t0 = originalAction.actionName;
                                _context20.next = 39;
                                return this.__chainAbiJsonToBin({ action: originalAction.actionName, args: originalAction.abi });

                            case 39:
                                _context20.t1 = _context20.sent.binargs;
                                _context20.t2 = originalAction.domain;
                                _context20.t3 = originalAction.key;
                                binAction = {
                                    name: _context20.t0,
                                    data: _context20.t1,
                                    domain: _context20.t2,
                                    key: _context20.t3
                                };
                            ...
                            case 47:
                                ...
                                return _context20.abrupt("return", { body: body, publicKeys: publicKeys });
                            ...
                            case 62:
                                digestRes = _context20.sent.digest;
                            ...
                            case 71:
                                ...
                                return _context20.abrupt("return", { transactionId: res.transaction_id });
        ...
        value: function () {
            var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21(abi) {
                var ret;
            ...
            function __chainAbiJsonToBin(_x24) {
        ...
        value: function () {
            var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(transaction) {
                var ret;
            ...
            function __getDigestToSign(_x25) {
...
var defaultSignProvider = function defaultSignProvider(apiCaller, config) {
    return function () {
        var _ref24 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee23(_ref23) {
            var sign = _ref23.sign,
                buf = _ref23.buf,
                transaction = _ref23.transaction,
                privateKeys = _ref23.privateKeys;
            ...
            return _regenerator2.default.wrap(function _callee23$(_context23) {
                while (1) {
                    switch (_context23.prev = _context23.next) {
                        ...
                        case 47:
                            _context23.prev = 47;
                            _context23.t1 = _context23["catch"](43);
                        ...
                        case 59:
                            return _context23.abrupt("return", sigs);
            ...
            }, _callee23, this, [[21, 25, 29, 37], [30,, 32, 36], [43, 47, 51, 59], [52,, 54, 58]]);
        }));
