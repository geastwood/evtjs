...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        key: 'getCreatedDomainList',
        value: function getCreatedDomainList(accountName, keyToUse) {
            return regeneratorRuntime.async(function getCreatedDomainList$(_context4) {
                while (1) {
