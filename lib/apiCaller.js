...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        value: function getFungibleBalance(address, symbol) {
            ...
            return regeneratorRuntime.async(function getFungibleBalance$(_context9) {
                while (1) {
        ...
        value: function getGroupDetail(name) {
            var res;
            return regeneratorRuntime.async(function getGroupDetail$(_context10) {
                while (1) {
        ...
        value: function getTransactionsDetailOfPublicKeys(publicKeys) {
            ...
            var body, res;
            return regeneratorRuntime.async(function getTransactionsDetailOfPublicKeys$(_context11) {
                while (1) {
        ...
        value: function getFungibleSymbolDetail(name) {
            var res;
            return regeneratorRuntime.async(function getFungibleSymbolDetail$(_context12) {
                while (1) {
        ...
        value: function __fixedSignatureCall(args) {
            ...
            return regeneratorRuntime.async(function __fixedSignatureCall$(_context13) {
                while (1) {
        ...
        value: function pushTransaction() {
            ...
            return regeneratorRuntime.async(function pushTransaction$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            ...
                            for (i = 0; i < _args14.length; ++i) {
                                actions.push(_args14[i]);
                            }
                        ...
                        case 11:
                            ...
                            _context14.t0 = originalAction.actionName;
                            _context14.next = 17;
                            return regeneratorRuntime.awrap(this.__chainAbiJsonToBin({ action: originalAction.actionName, args: originalAction.abi }));

                        case 17:
                            _context14.t1 = _context14.sent.binargs;
                            _context14.t2 = originalAction.domain;
                            _context14.t3 = originalAction.key;
                            binAction = {
                                name: _context14.t0,
                                data: _context14.t1,
                                domain: _context14.t2,
                                key: _context14.t3
                            };
                        ...
                        case 36:
                            digestRes = _context14.sent.digest;
                        ...
                        case 45:
                            ...
                            return _context14.abrupt("return", { transactionId: res.transaction_id });
        ...
        value: function __chainAbiJsonToBin(abi) {
            var ret;
            return regeneratorRuntime.async(function __chainAbiJsonToBin$(_context15) {
                while (1) {
        ...
        value: function __getDigestToSign(transaction) {
            var ret;
            return regeneratorRuntime.async(function __getDigestToSign$(_context16) {
                while (1) {
        ...
        return regeneratorRuntime.async(function _callee$(_context17) {
            while (1) {
                switch (_context17.prev = _context17.next) {
                    ...
                    case 76:
                        _context17.prev = 76;
                        _context17.t2 = _context17["catch"](72);
                    ...
                    case 86:
                        return _context17.finish(83);

                    case 87:
                        return _context17.finish(80);

                    case 88:
                        return _context17.abrupt("return", sigs);
