...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        value: function __calcKeyProvider(keyProvider, trx) {
            ...
            return regeneratorRuntime.async(function __calcKeyProvider$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        ...
                        case 5:
                            ...
                            _context17.prev = 10;
                            _iterator2 = keyProvider[Symbol.iterator]();
                        ...
                        case 33:
                            return _context17.abrupt("return", keyProvider);
                    ...
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            ...
                            if (_args18.length > 0 && !(_args18[0] instanceof EvtAction) && !_args18[0].action) {
                                // config found
                                Object.assign(trxConf, _args18[0]);
                                hasConfig = true;
                            }
                        ...
                        case 6:
                            ...
                            for (i = hasConfig ? 1 : 0; i < _args18.length; ++i) {
...
var defaultSignProvider = function defaultSignProvider(apiCaller, config) {
    return function _callee(_ref) {
        ...
        var keys, pvt, ret, apiRes, required_keys, pvts, missingKeys, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _loop, _iterator3, _step3, sigs, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _pvt;
