...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
                ...
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        ...
                        case 7:
                            ...
                            _context11.next = 11;
                            return regeneratorRuntime.awrap(this.__chainGetRequiredKeys({ transaction: p.body.transaction, available_keys: p.publicKeys }));
        ...
        value: function __calcPublicKeyProvider(keyProvider) {
            var _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, key;

            return regeneratorRuntime.async(function __calcPublicKeyProvider$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        ...
                        case 5:
                            ...
                            _context19.prev = 10;
                            _iterator4 = keyProvider[Symbol.iterator]();
        ...
        value: function pushTransaction() {
            ...
            return regeneratorRuntime.async(function pushTransaction$(_context20) {
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        case 0:
                            ...
                            if (_args20.length > 0 && !(_args20[0] instanceof EvtAction) && !_args20[0].action) {
                                // config found
                                Object.assign(trxConf, _args20[0]);
                                hasConfig = true;
                            }
                        ...
                        case 13:
                            _context20.next = 15;
                            return regeneratorRuntime.awrap(this.__calcPublicKeyProvider(trxConf.availablePublicKeys));
        ...
        value: function __chainAbiJsonToBin(abi) {
            var ret;
            return regeneratorRuntime.async(function __chainAbiJsonToBin$(_context21) {
                while (1) {
        ...
        value: function __getDigestToSign(transaction) {
            var ret;
            return regeneratorRuntime.async(function __getDigestToSign$(_context22) {
                while (1) {
...
var defaultSignProvider = function defaultSignProvider(apiCaller, config) {
    return function _callee(_ref) {
        ...
        var keys, pvt, ret, apiRes, required_keys, pvts, missingKeys, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _loop, _iterator5, _step5, sigs, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _pvt;
            ...
            while (1) {
                switch (_context23.prev = _context23.next) {
                    ...
                    case 13:
                        ...
                        for (_iterator5 = required_keys[Symbol.iterator](); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            _loop();
                        }
                    ...
                    case 39:
                        ...
                        for (_iterator6 = pvts[Symbol.iterator](); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                            _pvt = _step6.value;
        ...
        }, null, this, [[20, 25, 29, 37], [30,, 32, 36], [43, 47, 51, 59], [52,, 54, 58]]);
    };
};
