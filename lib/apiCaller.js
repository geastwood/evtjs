...
var APICaller = function () {
    ...
    (0, _createClass3.default)(APICaller, [{
        ...
        value: function () {
            ...
            function getTransactionIdForLinkId(_x20) {
        ...
        value: function () {
            var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(options) {
                ...
                return _regenerator2.default.wrap(function _callee15$(_context15) {
                    while (1) {
                        switch (_context15.prev = _context15.next) {
                            ...
                            case 23:
                                if (_context15.t0.isServerError) {
                                    lastTimeInternet = true;
                                }
                                lastError = _context15.t0;
                            ...
                            case 25:
                                ...
                                lastTimeInternet = true;
                                return _context15.abrupt("return", { pending: false, successful: true, transactionId: res.trx_id, blockNum: res.block_num });
                            ...
                            case 40:
                                ...
                                if (_context15.t1.isServerError) {
                                    lastTimeInternet = true;
                                }
                                ...
                                return _context15.abrupt("return", { pending: false, successful: false, exception: _context15.t1 });

                            case 45:

                                lastError = _context15.t1;
                            ...
                            case 47:
                                ...
                                return _context15.abrupt("return", { pending: false, successful: false, exception: lastError || new Error("everiPay timeOut or network issue") });

                            case 51:
                                return _context15.abrupt("return", { pending: true, exception: new Error("No available network connection") });
                ...
                }, _callee15, this, [[11, 17], [36, 40]]);
            }));

            function getStatusOfEvtLink(_x21) {
                ...
                return _regenerator2.default.wrap(function _callee16$(_context16) {
                    while (1) {
                        switch (_context16.prev = _context16.next) {
                            ...
                            case 7:
                                p = _context16.sent;
                                return _context16.abrupt("return", { transaction: p.body.transaction });
        ...
        value: function () {
            var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(blockId) {
                var res;
            ...
            function getTransactionIdsInBlock(_x23) {
        ...
        value: function () {
            var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee20(address, symbolId) {
            ...
            function getFungibleBalance(_x24, _x25) {
        ...
        value: function () {
            var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(symbolId, address) {
            ...
            function getFungibleActionsByAddress(_x29, _x30) {
        ...
        value: function () {
            var _ref23 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee23(publicKeys) {
            ...
            function getTransactionsDetailOfPublicKeys(_x34) {
        ...
        value: function () {
            var _ref24 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee24(id) {
                var res;
            ...
            function getFungibleSymbolDetail(_x35) {
        ...
        value: function () {
            var _ref26 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee26(keyProvider, trx) {
                ...
                return _regenerator2.default.wrap(function _callee26$(_context26) {
                    while (1) {
                        switch (_context26.prev = _context26.next) {
                            ...
                            case 33:
                                return _context26.abrupt("return", keyProvider);
                ...
                }, _callee26, this, [[10, 21, 25, 33], [26,, 28, 32]]);
            }));

            function __calcKeyProvider(_x36, _x37) {
        ...
        value: function () {
            var _ref27 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee27(keyProvider) {
                ...
                return _regenerator2.default.wrap(function _callee27$(_context27) {
                    while (1) {
                        switch (_context27.prev = _context27.next) {
                            ...
                            case 33:
                                return _context27.abrupt("return", keyProvider);
                ...
                }, _callee27, this, [[10, 21, 25, 33], [26,, 28, 32]]);
            }));

            function __calcPublicKeyProvider(_x38) {
                    ...
                    while (1) {
                        switch (_context28.prev = _context28.next) {
                            case 0:
                                ...
                                if (_args28.length > 0 && !(_args28[0] instanceof EvtAction) && !_args28[0].action) {
                                    // config found
                                    (0, _assign2.default)(trxConf, _args28[0]);
                                    hasConfig = true;
                                }
                            ...
                            case 16:
                                ...
                                for (i = hasConfig ? 1 : 0; i < _args28.length; ++i) {
                                    actions.push(_args28[i]);
                                }
                            ...
                            case 36:
                                ...
                                _context28.t0 = originalAction.actionName;
                                _context28.next = 40;
                                return this.__chainAbiJsonToBin({ action: originalAction.actionName, args: originalAction.abi });

                            case 40:
                                _context28.t1 = _context28.sent.binargs;
                                _context28.t2 = originalAction.domain;
                                _context28.t3 = originalAction.key;
                                binAction = {
                                    name: _context28.t0,
                                    data: _context28.t1,
                                    domain: _context28.t2,
                                    key: _context28.t3
                                };
                            ...
                            case 48:
                                _context28.t4 = function (x) {
                                    return x.typeKey == 156;
                                };

                                trxConf.__linkId = _context28.sent.segments.filter(_context28.t4)[0].value.toString("hex");
                            ...
                            case 65:
                                ...
                                _context28.t7 = _context28.t6 + 10000;
                                expiration = new _context28.t5(_context28.t7).toISOString().substr(0, 19);
                                _context28.next = 76;
                                break;
                            ...
                            case 73:
                                ...
                                _context28.t10 = _context28.t9 + 100000;
                                expiration = new _context28.t8(_context28.t10).toISOString().substr(0, 19);
                            ...
                            case 76:
                                ...
                                return _context28.abrupt("return", { body: body, publicKeys: publicKeys });
                            ...
                            case 89:
                                digestRes = _context28.sent.digest;
                            ...
                            case 102:
                                ...
                                return _context28.abrupt("return", { transactionId: ret.transactionId });
                            ...
                            case 110:
                                ...
                                return _context28.abrupt("return", { transactionId: res.transaction_id });
        ...
        value: function () {
            var _ref29 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee29(abi) {
                var ret;
                    ...
                    while (1) {
                        switch (_context29.prev = _context29.next) {
                            ...
                            case 2:
                                ...
                                return _context29.abrupt("return", ret);
            ...
            function __chainAbiJsonToBinByAPI(_x39) {
        ...
        value: function () {
            var _ref30 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee30(abi) {
                var obj, bin;
                    ...
                    while (1) {
                        switch (_context30.prev = _context30.next) {
                            case 0:
                                ...
                                return _context30.abrupt("return", bin.toString("hex"));
            ...
            function __chainAbiJsonToBinByFC(_x40) {
        ...
        value: function () {
            ...
            function __chainAbiJsonToBin(_x42) {
        ...
        value: function () {
            var _ref32 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee32(transaction) {
                var ret;
                    ...
                    while (1) {
                        switch (_context32.prev = _context32.next) {
                            ...
                            case 10:
                                ...
                                return _context32.abrupt("return", ret);
            ...
            function __getDigestToSign(_x43) {
...
var defaultSignProvider = function defaultSignProvider(apiCaller, config) {
    return function () {
        var _ref34 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee33(_ref33) {
            var sign = _ref33.sign,
                buf = _ref33.buf,
                transaction = _ref33.transaction,
                privateKeys = _ref33.privateKeys;
            ...
            return _regenerator2.default.wrap(function _callee33$(_context33) {
                while (1) {
                    switch (_context33.prev = _context33.next) {
                        ...
                        case 27:
                            _context33.prev = 27;
                            _context33.t0 = _context33["catch"](23);
                            _didIteratorError5 = true;
                            _iteratorError5 = _context33.t0;
                        ...
                        case 52:
                            ...
                            _context33.t1.push.call(_context33.t1, _context33.t2);
                        ...
                        case 59:
                            _context33.prev = 59;
                            _context33.t3 = _context33["catch"](45);
                            _didIteratorError6 = true;
                            _iteratorError6 = _context33.t3;
                        ...
                        case 69:
                            return _context33.finish(66);

                        case 70:
                            return _context33.finish(63);

                        case 71:
                            return _context33.abrupt("return", sigs);
            ...
            }, _callee33, this, [[23, 27, 31, 39], [32,, 34, 38], [45, 59, 63, 71], [64,, 66, 70]]);
        }));
