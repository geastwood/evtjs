...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        value: function getJoinedDomainList(accountName) {
        ...
        value: function getJoinedGroupList(accountName) {
        ...
        key: 'getOwnedTokens',
        value: function getOwnedTokens(accountName) {
        ...
        return regeneratorRuntime.async(function _callee$(_context9) {
            while (1) {
                switch (_context9.prev = _context9.next) {
                    ...
                    case 68:
                        _context9.prev = 68;
                        _context9.t2 = _context9['catch'](64);
