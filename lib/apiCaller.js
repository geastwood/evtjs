...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        value: function getEstimatedChargeForTransaction(transaction, signatureCount) {
            var res;
            return regeneratorRuntime.async(function getEstimatedChargeForTransaction$(_context11) {
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        case 0:
                            if (!((typeof transaction === "undefined" ? "undefined" : _typeof(transaction)) !== "object" || !transaction)) {
                                _context11.next = 2;
                                break;
                            }
                        ...
                        case 2:
                            ...
                            return regeneratorRuntime.awrap(this.__callAPI({
                                ...
                                method: "POST",
                                body: { transaction: transaction, sigs_num: signatureCount },
                                sign: false // no need to sign
                            }));
        ...
        value: function __fixedSignatureCall(args) {
            ...
            return regeneratorRuntime.async(function __fixedSignatureCall$(_context17) {
                while (1) {
        ...
        value: function pushTransaction() {
            ...
            return regeneratorRuntime.async(function pushTransaction$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            ...
                            if (_args18.length > 0 && !(_args18[0] instanceof EvtAction) && !_args18[0].action) {
                                // config found
                                trxConf = _args18[0];
                            }
                            ...
                            _context18.next = 15;
                            return regeneratorRuntime.awrap(kp[0]);

                        case 15:
                            kp[0] = _context18.sent;
                        ...
                        case 18:
                            ...
                            for (i = trxConf ? 1 : 0; i < _args18.length; ++i) {
                                actions.push(_args18[i]);
                            }
                        ...
                        case 28:
                            ...
                            _context18.t0 = originalAction.actionName;
                            _context18.next = 34;
                            return regeneratorRuntime.awrap(this.__chainAbiJsonToBin({ action: originalAction.actionName, args: originalAction.abi }));

                        case 34:
                            _context18.t1 = _context18.sent.binargs;
                            _context18.t2 = originalAction.domain;
                            _context18.t3 = originalAction.key;
                            binAction = {
                                name: _context18.t0,
                                data: _context18.t1,
                                domain: _context18.t2,
                                key: _context18.t3
                            };
                        ...
                        case 54:
                            digestRes = _context18.sent.digest;
                        ...
                        case 63:
                            ...
                            return _context18.abrupt("return", { transactionId: res.transaction_id });
        ...
        value: function __chainAbiJsonToBin(abi) {
            var ret;
            return regeneratorRuntime.async(function __chainAbiJsonToBin$(_context19) {
                while (1) {
        ...
        value: function __getDigestToSign(transaction) {
            var ret;
            return regeneratorRuntime.async(function __getDigestToSign$(_context20) {
                while (1) {
...
var defaultSignProvider = function defaultSignProvider(apiCaller, config) {
    return function _callee(_ref) {
        ...
        var keyProvider, keys, pvt, ret, keyMap, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, key, isPrivate, isPublic, pubkeys, _pvt, apiRes, required_keys, pvts, missingKeys, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, requiredKey, wif, _wif, sigs, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _pvt2;
                ...
                switch (_context21.prev = _context21.next) {
                    ...
                    case 43:
                        ...
                        return regeneratorRuntime.awrap(apiCaller.__chainGetRequiredKeys({ transaction: transaction, available_keys: keys.map(function (key) {
                                return EvtKey.privateToPublic(key.private);
                            }) }));

                    case 45:
                        apiRes = _context21.sent;
                        ...
                        _context21.prev = 51;
                        for (_iterator3 = required_keys[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                            requiredKey = _step3.value;
                    ...
                    case 55:
                        _context21.prev = 55;
                        _context21.t1 = _context21["catch"](51);
                    ...
                    case 67:
                        ...
                        for (_iterator4 = pvts[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                            _pvt2 = _step4.value;
                    ...
                    case 76:
                        _context21.prev = 76;
                        _context21.t2 = _context21["catch"](72);
                    ...
                    case 88:
                        return _context21.abrupt("return", sigs);
