...
var APICaller = function () {
    ...
    _createClass(APICaller, [{
        ...
        key: 'getActionsOfDomains',
        value: function getActionsOfDomains(params) {
            var res;
            return regeneratorRuntime.async(function getActionsOfDomains$(_context6) {
                while (1) {
         ...
         * @param {Object} params arguments to use for pushing 
         */

    }, {
        key: 'pushTransaction',
        value: function pushTransaction(params) {
            var body, i, originalAction, binAction, expiration, hash, numHex, last_irreversible_block_num, last_irreversible_block_prefix, digestRes, signBuf, sigs, res;
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 2:
                            ...
                            body = { transaction: JSON.parse(JSON.stringify(params.transaction)) };
                        ...
                        case 8:
                            if (!(i < body.transaction.actions.length)) {
                                _context13.next = 20;
                                break;
                            }

                            originalAction = body.transaction.actions[i];

                            // create binary action for push_transaction

                            _context13.t0 = originalAction.action;
                            _context13.next = 13;
        ...
        return regeneratorRuntime.async(function _callee$(_context16) {
            while (1) {
                switch (_context16.prev = _context16.next) {
                    ...
                    case 56:
                        _context16.prev = 56;
                        _context16.t1 = _context16['catch'](52);
                    ...
                    case 77:
                        _context16.prev = 77;
                        _context16.t2 = _context16['catch'](73);
                    ...
                    case 87:
                        return _context16.finish(84);

                    case 88:
                        return _context16.finish(81);
