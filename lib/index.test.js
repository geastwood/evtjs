...
it('Test APICaller AbiToBin', function _callee2() {
    var apiCaller, chainInfo, hash, numHex, last_irreversible_block_num, last_irreversible_block_prefix, expiration, rawTrx, response, binargs, pushedTrx, digest, signBuf, sigs, pushResult;
