            ...
            while (1) {
                switch (_context16.prev = _context16.next) {
                    case 0:
                        ...
                        _context16.next = 3;
                        return regeneratorRuntime.awrap(apiCaller.getTransactionsDetailOfPublicKeys("EVT85QEkmFpnDwR4NjnYenqenyCxFRQc45HwjGLNpXQQ1JuSmBzSj"));
...
describe("EvtLink", function () {
    ...
    it("everiPass1", function _callee25() {
        var link, parsed;
            ...
            while (1) {
                switch (_context25.prev = _context25.next) {
                    case 0:
                        ...
                        _context25.t1 = evtLink;
                        _context25.t2 = testingTmpData.newDomainName;
                        _context25.t3 = testingTmpData.addedTokenNamePrefix + "1";
                        _context25.t4 = [wif, wif2, wif3];
                        _context25.next = 7;
                        return regeneratorRuntime.awrap(evtLink.getUniqueLinkId());

                    case 7:
                        _context25.t5 = _context25.sent;
                        _context25.t6 = {
                            autoDestroying: true,
                            domainName: _context25.t2,
                            tokenName: _context25.t3,
                            keyProvider: _context25.t4,
                            linkId: _context25.t5
                        };
                        _context25.t7 = _context25.t1.getEveriPassText.call(_context25.t1, _context25.t6);
                        _context25.next = 12;
    ...
    it("everiPass2", function _callee26() {
        var link, parsed;
            ...
            while (1) {
                switch (_context26.prev = _context26.next) {
                    case 0:
                        ...
                        _context26.t1 = evtLink;
                        _context26.t2 = testingTmpData.newDomainName;
                        _context26.t3 = testingTmpData.addedTokenNamePrefix + "1";
                        _context26.t4 = [wif];
                        _context26.next = 7;
                        return regeneratorRuntime.awrap(evtLink.getUniqueLinkId());
                    ...
                    case 7:
                        ...
                        _context26.t6 = {
                            ...
                            domainName: _context26.t2,
                            tokenName: _context26.t3,
                            keyProvider: _context26.t4,
                            linkId: _context26.t5
                        };
                        _context26.t7 = _context26.t1.getEveriPassText.call(_context26.t1, _context26.t6);
                        _context26.next = 12;
