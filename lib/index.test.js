...
describe("APICaller write API test", function () {
    it("newdomain", function _callee5() {
        var apiCaller, res;
    ...
    it("issue_tokens", function _callee6() {
        var apiCaller;
    ...
    it("new_group", function _callee7() {
        var apiCaller;
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        ...
                        _context7.next = 4;
                        return regeneratorRuntime.awrap(apiCaller.pushTransaction(new EVT.EvtAction("newgroup", {
