                                        ...
                                        while (1) {
                                            switch (_context20.prev = _context20.next) {
                                                case 0:
                                                    ...
                                                    _context20.next = 3;
                                                    return apiCaller.getTransactionDetailById("bed1272c6de3294582910c968b93f1c015eb646181174ab5a705df35b024f65d");

                                                case 3:
                                                    response = _context20.sent;
                                                    //testingTmpData.newTrxId);
...
describe("EvtLink", function () {
    ...
    it("everiPay", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee28() {
        var link, parsed;
        return _regenerator2.default.wrap(function _callee28$(_context28) {
            while (1) {
                switch (_context28.prev = _context28.next) {
                    case 0:
                        _context28.t0 = evtLink;
                        _context28.t1 = [wif2];
                        _context28.next = 4;
                    ...
                    case 4:
                        ...
                        _context28.t3 = {
                            symbol: "EVT",
                            maxAmount: 354,
                            keyProvider: _context28.t1,
                            linkId: _context28.t2
                        };
                        _context28.next = 8;
                        return _context28.t0.getEvtLinkForEveriPay.call(_context28.t0, _context28.t3);
    ...
    it("everiPay_execPush", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee29() {
        var link, apiCaller;
            ...
            while (1) {
                switch (_context29.prev = _context29.next) {
                    ...
                    case 8:
                        ...
                        _context29.next = 12;
                        return apiCaller.pushTransaction({ maxCharge: 10000 }, new EVT.EvtAction("everipay", {
                            link: link.rawText,
    ...
    it("everiPass_execPush", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee30() {
        var link, apiCaller;
            ...
            while (1) {
                switch (_context30.prev = _context30.next) {
                    case 0:
                        ...
                        _context30.t1 = testingTmpData.newDomainName;
                        _context30.t2 = testingTmpData.addedTokenNamePrefix + "1";
                        _context30.t3 = [wif];
                        _context30.next = 6;
                        return evtLink.getUniqueLinkId();
                    ...
                    case 6:
                        ...
                        _context30.t5 = {
                            autoDestroying: true,
                            domainName: _context30.t1,
                            tokenName: _context30.t2,
                            keyProvider: _context30.t3,
                            linkId: _context30.t4
                        };
                        _context30.next = 10;
                        return _context30.t0.getEvtLinkForEveriPass.call(_context30.t0, _context30.t5);
                    ...
                    case 10:
                        ...
                        _context30.next = 14;
                        return apiCaller.pushTransaction({ maxCharge: 10000 }, new EVT.EvtAction("everipass", {
                            link: link.rawText
                        }));
    ...
    it("parse evtLink", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee31() {
        var parsed;
    ...
    it("parse bad evtLink", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee32() {
