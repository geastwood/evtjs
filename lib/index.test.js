...
describe("APICaller read API test", function () {
    ...
    it("getCreatedDomains", function _callee11() {
        var apiCaller, response;
    ...
    it("getManagedGroups", function _callee12() {
        var apiCaller, response;
    ...
    it("getOwnedTokens", function _callee13() {
        var apiCaller, response;
    ...
    it("getActions", function _callee14() {
        var apiCaller, response;
    ...
    it("getTransactionsDetailOfPublicKeys", function _callee15() {
        var apiCaller, response;
    ...
    it("getFungibleSymbolDetail", function _callee16() {
        var apiCaller, response;
    ...
    it("getDomainDetail", function _callee17() {
        var apiCaller, response;
    ...
    it("getGroupDetail", function _callee18() {
        var apiCaller, response;
    ...
    it("getTransactionDetailById", function _callee19() {
        var apiCaller, response;
    ...
    it("getFungibleBalance", function _callee20() {
        var apiCaller, response;
    ...
    it("getRequiredKeysForSuspendedTransaction", function _callee21() {
        var apiCaller;
    ...
    it("getSuspendedTransactionDetail", function _callee22() {
        var apiCaller;
