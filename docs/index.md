...
<dd></dd>
<dt><a href="#encodeName128">encodeName128(name)</a> ⇒ <code>string.&lt;uint64&gt;</code></dt>
<dd><p>Encode a name (a base32 string) to a number.</p>
<p>  For performance reasons, the blockchain uses the numerical encoding of strings
  for very common types like account names.</p>
</dd>
<dt><a href="#decodeName128">decodeName128(value)</a> ⇒ <code>string</code></dt>
<dd></dd>
...
<dt><a href="#parseAssetSymbol">parseAssetSymbol(assetSymbol, [precision])</a></dt>
<dd></dd>
</dl>
...
<a name="encodeName128"></a>

## encodeName128(name) ⇒ <code>string.&lt;uint64&gt;</code>
Encode a name (a base32 string) to a number.
...
<a name="decodeName128"></a>

## decodeName128(value) ⇒ <code>string</code>
**Kind**: global function  
...
<a name="parseAssetSymbol"></a>

## parseAssetSymbol(assetSymbol, [precision])
**Kind**: global function  
**Throws**:
...
| --- | --- | --- | --- |
| assetSymbol | <code>string</code> |  | 4,SYM |
| [precision] | <code>number</code> | <code></code> | expected precision or mismatch AssertionError |
